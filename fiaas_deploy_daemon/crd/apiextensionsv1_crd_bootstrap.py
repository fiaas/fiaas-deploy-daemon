...
class ApiextensionsV1CrdBootstrapper(object):
    def __init__(self):
        def _create(kind, plural, short_names, group, schema_properties):
        ...
        def bootstrap():
            ...
            _create("Application", "applications", ("app", "fa"), "fiaas.schibsted.io", application_schema_properties)
