...
We try to keep test coverage stable or increasing, and use
[QualityGate](https://confluence.schibsted.io/display/SPTP/Quality+Gate) to manage this. Pull requests must pass
