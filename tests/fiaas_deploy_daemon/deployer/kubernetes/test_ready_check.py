...
class TestReadyCheck(object):
    ...
    def test_deployment_complete(self, get, app_spec, bookkeeper, generation, observedGeneration, lifecycle, lifecycle_subject):
    ...
    def test_deployment_incomplete(self, get, app_spec, bookkeeper, requested, replicas, available, updated,
                                   generation, observedGeneration, lifecycle, lifecycle_subject):
